import { Bot, Eye, Users, Shield, Swords, Crosshair, FlaskConical } from 'lucide-react';
...
const roles = [
  {
    icon: Bot,
    title: 'Game Master',
    description: 'Oversee the match, monitor AI, and control game variables.',
    href: '/gm',
    color: 'text-primary',
  },
  {
    icon: Eye,
    title: 'Spectator',
    description: 'Watch the game unfold from a neutral perspective.',
    href: '/spectator',
  ...
  },
  {
    icon: Users,
    title: 'Player',
    description: 'Join the Blue or Red team and lead your squad to victory.',
    href: '/team-selection',
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-1 p-4 md:p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="mb-6 text-3xl font-bold text-center font-headline">Choose Your Role</h2>
              ...
              <Card key={role.title} className="flex flex-col text-center transition-all duration-300 hover:shadow-lg hover:border-primary">
                ...
                <div className="p-6 pt-0">
                  <Button asChild className="w-full">
                    <Link href={role.href}>Select</Link>
                  </Button>
                </div>
              </Card>
            ))}
